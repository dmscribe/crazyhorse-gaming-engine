...
High-precision native C++20 core framework with unified asset
pipelines, multi-genre kernel support, and a decoupled DOM/SVG
web runtime utilizing WebGL 2 and Three.js.

engine/assets/brand/logo.png is used on splash, titlebar, and About.
Do not invent mark art. C++ is source of truth. Three.js r0.185.1
is a browser preview RHI adapter for the slice, not the engine.
Launch and Editor are DOM and must boot with no GPU.
